...
def getClass(val_v, ar_a, dom_d):
    V_and_A_and_D = []
    for ind_va in range(len(val_v)):
        V_and_A_and_D.append(val_v[ind_va] * 1 + ar_a[ind_va] * 2 + dom_d[ind_va] * 4)
    return V_and_A_and_D
...
for file in files:
    ...
    label_eight_VAD = getClass(VLC, ARS, DMN)
    print(dict(Counter(label_eight_VAD)))
